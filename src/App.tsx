        ...
        <div className="flex justify-between items-center">
          <div className="cursor-pointer pointer-events-auto group" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-[10px] sm:text-sm md:text-lg font-medium font-orbitron tracking-[0.1em] md:tracking-[0.3em] text-[#b0b0b0] group-hover:opacity-80 transition-opacity hidden min-[400px]:block">MIGUEL VIRGÍLIO STUDIO</span>
            </div>
          </div>
